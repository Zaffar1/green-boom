...
class ProductAllDataController extends Controller
{
    public function allProductData($id)
    {
        try {
            ...
            if ($product_small) {
                $product_data_small['product_small'] = $product_small;
                ...
                if ($product_small_dimension) {
                    $product_data_small['product_small_dimension'] = $product_small_dimension;
                } else {
                    $product_data_small['product_small_dimension'] = [];
                }
                ...
                if ($product_data_title_sku) {
                    $product_data_small['product_data_title_sku'] = $product_data_title_sku;
                } else {
                    $product_data_small['product_data_title_sku'] = [];
                }
            ...
            if ($product_medium) {
                ...
                if ($product_medium_dimension) {
                    $product_data_medium['product_medium_dimension'] = $product_medium_dimension;
                } else {
                    $product_data_medium['product_medium_dimension'] = [];
                }

                // Medium size title_sku
                $product_data_title_sku = ProductDataTitle::whereProductDataSizeId($product_medium->id)->first();
                if ($product_data_title_sku) {
                    $product_data_medium['product_data_title_sku'] = $product_data_title_sku;
                } else {
                    $product_data_medium['product_data_title_sku'] = [];
                }
            ...
            if ($product_large) {
                $product_data_large['product_large'] = $product_large;
                ...
                if ($product_large_dimension) {
                    $product_data_large['product_large_dimension'] = $product_large_dimension;
                } else {
                    $product_data_large['product_large_dimension'] = [];
                }

                // Large size title_sku
                $product_data_title_sku = ProductDataTitle::whereProductDataSizeId($product_large->id)->first();
                if ($product_data_title_sku) {
                    $product_data_large['product_data_title_sku'] = $product_data_title_sku;
                } else {
                    $product_data_large['product_data_title_sku'] = [];
                }
